...
"")
        ...
        self.diff = QtWidgets.QLineEdit(self.widget1)
        self.diff.setStyleSheet("background-color: white;\n"
"height: 40px;\n"
"font-size: 25px;\n"
"")
        self.diff.setText("")
        self.diff.setObjectName("diff")
        self.gridLayout_2.addWidget(self.diff, 28, 0, 1, 1)
...
"")
        ...
        self.Diff = QtWidgets.QLabel(self.widget1)
        self.Diff.setStyleSheet("font-size: 24px;")
        self.Diff.setObjectName("Diff")
        self.gridLayout_2.addWidget(self.Diff, 27, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Diff.setText(_translate("MainWindow", "отличие главного движения от расчетного"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.widget1), _translate("MainWindow", "Попровки"))
        self.PRN.setText(_translate("MainWindow", "PRN - номер НКА"))
        self.pushButton_3.setText(_translate("MainWindow", "Navigation Message"))
